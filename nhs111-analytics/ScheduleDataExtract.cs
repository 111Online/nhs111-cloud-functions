...
namespace NHS111.Cloud.Functions
{
    public static class ScheduleDataExtract
    {
        ...
        public static async Task Run([TimerTrigger("5 * * * * *")]TimerInfo timer, [OrchestrationClient]DurableOrchestrationClient starter, [Table("AnalyticsEmailTable", "AzureContainerConnection")]IQueryable<AnalyticsEmail> analyticsEmails, [Table("AnalyticsEmailTable", "AzureContainerConnection")]CloudTable outTable, TraceWriter log)
        {
